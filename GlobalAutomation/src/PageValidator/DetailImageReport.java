...
public class DetailImageReport {

	@Test
		public  void DetailImage() throws EncryptedDocumentException, InvalidFormatException, IOException {
			
			FileInputStream fis=new FileInputStream("C:/Selenium/Testdata/Global.xlsx");
			Workbook wb=WorkbookFactory.create(fis);
			Sheet s=wb.getSheet("DetailedImageReport");
			s.createRow(0);
