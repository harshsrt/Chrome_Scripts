...
public class DuplicateId {
  @Test
  public void duplicateId() throws IOException, EncryptedDocumentException, InvalidFormatException {
      ...
      //create a workbook
		...
		//if size of list is not null, duplicate ids found
		{
			System.out.println("Duplicate id found ! Please report a bug");
				...
				wb.write(fos);
				Assert.assertEquals(alldupId.size(),0);
